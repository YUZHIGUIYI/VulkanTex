...
#pragma pack(push,1)
    ...
    constexpr uint32_t DDS_ALPHAPIXELS   = 0x00000001;  // DDPF_ALPHAPIXELS
    constexpr uint32_t DDS_ALPHA         = 0x00000002;  // DDPF_ALPHA
    constexpr uint32_t DDS_PAL8          = 0x00000020;  // DDPF_PALETTEINDEXED8
    constexpr uint32_t DDS_PAL8A         = 0x00000021;  // DDPF_PALETTEINDEXED8 | DDPF_ALPHAPIXELS
    constexpr uint32_t DDS_BUMPLUMINANCE = 0x00040000;  // DDPF_BUMPLUMINANCE
    constexpr uint32_t DDS_BUMPDUDV      = 0x00080000;  // DDPF_BUMPDUDV
    constexpr uint32_t DDS_BUMPDUDVA     = 0x00080001;  // DDPF_BUMPDUDV | DDPF_ALPHAPIXELS
...
#define MAKEFOURCC(ch0, ch1, ch2, ch3) \
    ...
    constexpr uint32_t DDS_HEADER_FLAGS_TEXTURE    = 0x00001007;  // DDSD_CAPS | DDSD_HEIGHT | DDSD_WIDTH | DDSD_PIXELFORMAT
    ...
    constexpr uint32_t DDS_SURFACE_FLAGS_MIPMAP  = 0x00400008; // DDSCAPS_COMPLEX | DDSCAPS_MIPMAP
